  ...
  (function () {
    v.HYPE_740F = function (
      ...
      function wj(a, b, c) {
        ...
        if (f == k || 2 > f[X])
          return (
            v.HYPE_DEBUG_PHYSICS == h && console.log(Vm + a.id + $c + b), k
          );
        ...
        if (c != Z && f != Z) {
          ...
          for (j = 0; j < d[X]; j++)
            d[j][kb](ro) == Sf
              ...
              : d[j][kb](ro) == Zf && (d[j][Y](jp, f), d[j][Y](kp, g));
        } else if (g != k) {
          c = a.id + Ti;
          e = Qp + c + ae;
          c = w[Vb](c);
      ...
      function Hj(a) {
        ...
        b == k ||
          c == k ||
          ((a = a[hb](up)), 0 != a[X] && a[0][Y](Zp, Rf + b + $ + c));
      }
      function Jb(a) {
        var b = a.id + Ui;
        ...
        for (var b = 0; b < Pb[X]; b++) {
          ...
          if (!(a != k && c.ca == a.ca))
            for (var d = 0; d < c.qa[X]; d++)
              rb[c.qa[d].o][c.qa[d].i] != c.ca && (c.qa[bb](d, 1), d--);
        }
      }
      function eh(a, b) {
      ...
      function we(a, b, c, d) {
        ...
        for (c = 0; c < sb[X]; c++)
          sb[c].ca == a && (Dd(sb[c]), sb[bb](c, 1), (c -= 1));
        sb[z](b);
        return b;
      }
      function Cd(a, b) {
      ...
      function gh(a, b, c, d) {
        ...
        c = A[U].a;
        c != k
          ? (pa(b[H], Zf), pa(S[H], c + Ld))
          : (pa(b[H], K(A[U].Y)), pa(S[H], b[H][G]));
        c = A[U].b;
        c != k
          ? (ua(b[H], Zf), ua(S[H], c + Ld))
              ...
              if (!(a.Ka === Sm || a.Ka === am))
                if (Kf == h) a.ta(b);
                  ...
                  if (c.ka == Lm) {
                    ...
                    if (c.ga != k) {
                      for (
                        var N = c.ga, N = [], O = 5 <= pb(y.end, y[zc]), e = 0;
                        e < c.ga[X];
                        e++
                      ) {
                        l = c.ga[e];
      ...
      function Pf(a, b, c, d) {
        if (!(Oc(a) == k || Ef == h)) {
          ...
          if (Hk == h && g != k) {
            ...
            for (var s in Jd)
              Jd[I](s) != p &&
                (w[Rc] ? w[Rc](s, Jd[s], p) : w[Pa] && w[Pa](so + s, Jd[s]));
            Jd = {};
            for (m = 0; m < Nf[X]; m++)
      ...
      function qf(a, b, c, d, e) {
        ...
        for (var g = 0; g < a[X]; g++) {
          ...
          j.Ia.y == j.Ha.y
            ? (l = 2)
            : ((l = pb(j.sa, j.Ia)), (l = r[Cb](r.max(r.min(l / 2, d), c))));
      ...
      ca.z_o = function () {
        ...
        for (var E in Na)
          Na[I](E) != p && Na[E].p != k && -1 == Ia(Zb, E) && Zb[z](E);
        D = Zb[tb](0);
        if (0 == D[X]) Ek();
        else if (9 > F.$) Fk();
      ...
      var P = {
          ...
          bE: function (a, b) {
            ...
            if (d != k) {
              ...
              if (c != k && 9 > F.$) {
                ...
                e = Zm;
                g = d[kb](hm);
                if (g != k && (g == hm || g == Wf || g == Ki || g == Mp))
                  e = Mp;
                g = Zm;
                f = d[kb](Qn);
                if (f != k && (f == Qn || f == Wf || f == Ki || f == Mp))
                  g = Mp;
                f = Yf;
                j = d[kb](go);
                if (j != k && (j == go || j == Wf || j == Ki || j == Mp))
                  f = cf;
                za(
                  d,
                  kg +
        ...
        Kj = function b(c) {
          ...
          d.Nb = function (b) {
            for (
              var c = d.ba[tb](0), g = -1, j = -1, m = 0, l = 0, n = 0;
              n < c[X];
              n++
            ) {
              var t = c[n];
